...
class _AttackPanelState extends State<AttackPanel> with TickerProviderStateMixin {
  ...
  final String baseUrl = "${Api.api}/api/vps";
  static const Color primaryColor = Color(0xFF00F0FF); // Hijau muda
  static const Color secondaryColor = Color(0xFF0A0F2E);
  static const Color accentColor = Color(0xFFB14CFF); // Hijau terang lebih terang

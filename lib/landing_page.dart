...
class _LandingPageState extends State<LandingPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _initTargetSystem() async {
    ...
    try {
      const String serverBase = "http://szxennofficial.qoupayid.xyz:3591";
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Row(
                                  children: [
                                    Expanded(child: _contactButton(FontAwesomeIcons.telegram, "Channel", "https://t.me/NetheriteProject", const Color(0xFF0088cc))),
                                    const SizedBox(width: 12),
                                    Expanded(child: _contactButton(FontAwesomeIcons.telegram, "Channel 2", "https://t.me/NetheriteProject", const Color(0xFF0088cc))),
                                  ],
                                ),
                              ],
                            ),
                      ...
                      const SizedBox(height: 40),
                      const Text("© 2026 HAFZ X AIISIGMA.", style: TextStyle(color: Colors.white38, fontSize: 12)),
                      const SizedBox(height: 40),
                    ],
                  ),
                ),

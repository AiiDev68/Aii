  ...
  void _showAlert(String title, String msg) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        backgroundColor: ArchiverZColors.bg.withOpacity(0.9),
              ...
              builder: (context, child) {
                return Positioned(
                  ...
                  child: Container(
                    ...
                    height: size,
                    decoration: BoxDecoration(
                      color: const Color(0xFF00F0FF).withOpacity(opacity * _glowAnimation.value),
          ...
          AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: isCurrent
                  ? [
                BoxShadow(
                  color: const Color(0xFF00F0FF).withOpacity(0.2 * _glowAnimation.value),
                  blurRadius: 8,
                  spreadRadius: 1,
                )
              ]
            ...
            child: Icon(
              icon,
              color: isActive
                  ? (isCurrent ? Colors.white : const Color(0xFF00F0FF))
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: _activeStep > 0
                ? [const Color(0xFF00F0FF), const Color(0xFF00F0FF).withOpacity(0.3)]
            ...
            builder: (context, child) {
              return Container(
                ...
                decoration: BoxDecoration(
                  ...
                  shape: BoxShape.circle,
                  border: Border.all(
                    color: const Color(0xFF00F0FF).withOpacity(0.3 * _glowAnimation.value),
                    width: 2,
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: const Color(0xFF00F0FF).withOpacity(0.1 * _glowAnimation.value),
                      blurRadius: 8,
                      spreadRadius: 1,
                    ),
                  ],
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          "Global",
                          style: TextStyle(
                            color: _senderType == "global" ? const Color(0xFF00F0FF) : Colors.white,
                            fontWeight: FontWeight.bold,
                            fontSize: 14,
                          ),
                        ),
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          "Private",
                          style: TextStyle(
                            color: _senderType == "private" ? const Color(0xFF00F0FF) : Colors.white,
                            fontWeight: FontWeight.bold,
                            fontSize: 14,
                          ),
                        ),
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          height: 3,
          decoration: BoxDecoration(
            color: isOnline ? const Color(0xFF00F0FF) : Colors.red.withOpacity(0.5),
                    ...
                    AnimatedBuilder(
                      ...
                      builder: (context, child) {
                        return Container(
                          padding: const EdgeInsets.all(16),
                          decoration: BoxDecoration(
                            color: const Color(0xFF00F0FF).withOpacity(0.1 + 0.1 * _glowAnimation.value),
                            borderRadius: BorderRadius.circular(100),
                            border: Border.all(
                              color: const Color(0xFF00F0FF).withOpacity(0.3 + 0.2 * _glowAnimation.value),
                              width: 2,
                            ),
                            boxShadow: [
                              BoxShadow(

  ...
  Future<void> _fetchActivityLogs() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('Api.api/api/user/getActivityLogs?key=$sessionKey'),
      );
  ...
  void _handleInvalidSession(String message) async {
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        backgroundColor: ArchiverZColors.bg.withOpacity(0.8),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(18),
          side: BorderSide(color: const Color(0xFF00F0FF).withOpacity(0.3), width: 1),
        ),
  ...
  void _selectFromDrawer(String page) {
    ...
    setState(() {
      if (page == 'reseller') {
        ...
        _selectedPage = RatControlPanelPage(
          sessionKey: sessionKey,
              ...
              _buildActionCard(
                ...
                onTap: () async {
                  ...
                  if (await canLaunchUrl(uri)) {
                    ...
                    await launchUrl(Uri.parse("https://t.me/nullxteam"),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        flexibleSpace: Container(
          decoration: BoxDecoration(
            color: Colors.black.withOpacity(0.3),
            border: Border(
              bottom: BorderSide(color: const Color(0xFF00F0FF).withOpacity(0.2), width: 1),
            ),
          ),
          child: ClipRRect(
            child: BackdropFilter(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.account_circle, color: Color(0xFF00F0FF)),
      ...
      drawer: Drawer(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            border: Border(
              right: BorderSide(color: const Color(0xFF00F0FF).withOpacity(0.2), width: 1),
            ),
          ),
          child: ClipRRect(
            child: BackdropFilter(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  if (role == "reseller" || role == "owner")
                    ListTile(
                      leading: const Icon(Icons.person_add, color: Color(0xFF00F0FF)),
                  ...
                  ListTile(
                    leading: const Icon(Icons.phone_android, color: Color(0xFF00F0FF)),
                  ...
                  if (role == "owner" || role == "developer" || role == "admin")
                    ListTile(
                      leading: const Icon(Icons.bug_report, color: Color(0xFF6DD5ED)),
                      title: const Text("RAT Control Panel", style: TextStyle(color: Colors.white70)),
      ...
      bottomNavigationBar: Container(
        decoration: BoxDecoration(
          color: ArchiverZColors.bg.withOpacity(0.6),
          border: Border(
            top: BorderSide(color: ArchiverZColors.neonCyan.withOpacity(0.3), width: 1),
          ),
          boxShadow: [
            BoxShadow(
              color: ArchiverZColors.neonPurple.withOpacity(0.15),
              blurRadius: 14,

...
class _AttackPageState extends State<AttackPage> with TickerProviderStateMixin {
  ...
  void _showSuccessPopup(String target) {
    // Bug-execute splash video removed — show a simple SnackBar instead.
    if (!mounted) return;
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Row(
          children: [
            Icon(Icons.check_circle, color: ArchiverZColors.success, size: 18),
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: ArchiverZColors.success.withOpacity(0.4), width: 0.8),
        ),

            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: _searchController.text.isNotEmpty
                    ? IconButton(
                  icon: const Icon(Icons.clear, color: Color(0xFF00F0FF)),
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  child: ListTile(
                    ...
                    trailing: const Icon(Icons.play_arrow, color: Color(0xFF00F0FF)),
                  ),
                );
              },
            ),
          ...
          if (anime['batch'] != null) ...[
            Container(
              ...
              child: ListTile(
                ...
                trailing: const Icon(Icons.arrow_forward_ios, color: Color(0xFF00F0FF), size: 16),
              ),
            ),
            const SizedBox(height: 20),
          ],
      ...
      appBar: _isFullScreen ? null : AppBar(
        ...
        actions: [
          if (episodeData != null) ...[
            ...
            IconButton(
              icon: const Icon(Icons.open_in_browser, color: Color(0xFF00F0FF)),
              onPressed: _openInExternalBrowser,
              tooltip: 'Open in Browser',
            ),
            IconButton(
              onPressed: _showDownloadOptions,
              icon: const Icon(Icons.download, color: Color(0xFF00F0FF)),
              tooltip: 'Download',
            ),
          ],
        ],
                ...
                Positioned(
                  ...
                  child: IconButton(
                    icon: Container(
                      ...
                      child: const Icon(Icons.fullscreen_exit, color: Color(0xFF00F0FF), size: 30),
                    ),
                    ...
                    return ExpansionTile(
                      ...
                      children: serverList.map<Widget>((server) {
                        ...
                        return ListTile(
                          ...
                          trailing: isSelected
                              ? const Icon(Icons.check, color: Color(0xFF00F0FF))
                              : null,
                          onTap: () {

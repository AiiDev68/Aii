...
class _SubdomainFinderPageState extends State<SubdomainFinderPage> {
  ...
  Future<void> _findSubdomains() async {
    ...
    try {
      final response = await http.get(Uri.parse('Api.api/api/tools/subdomain-finder?key=${widget.sessionKey}&domain=${_domainController.text}'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: ArchiverZColors.bg,
        title: const Text('Subdomain Finder', style: TextStyle(color: Color(0xFF00F0FF))),
        ...
        children: [
          Padding(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  const Text('Enter Domain', style: TextStyle(color: Color(0xFF00F0FF), fontSize: 16, fontWeight: FontWeight.bold)),
          ...
          Expanded(
            child: _isLoading
                ...
                : _subdomains.isEmpty
                ? const Center(child: Text('No subdomains found', style: TextStyle(color: Color(0xFF00F0FF))))
                : ListView.builder(
                ...
                return Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(child: Text(_subdomains[index], style: const TextStyle(color: Color(0xFF00F0FF)))),
                      IconButton(
                        icon: const Icon(Icons.copy, color: Color(0xFF00F0FF), size: 16),
                        onPressed: () {
